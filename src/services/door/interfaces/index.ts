...
export const sortPostByIdComparator = <T extends Post>(
	postA: T,
	postB: T,
): number => {
...
export const sortPostByCreatedAt = <T extends Post>(
	map: FetchableMap<T>,
): T[] => {
	return Object.values(map.items).sort(sortPostByCreatedAtComparator);
};

export const sortPostByCreatedAtComparator = <T extends Post>(
	postA: T,
	postB: T,
): number => {
