...
export const sequentialCourseActions = function *(courseId: ID): IterableIterator<CurrentAction> {
	// Get current state
	...
	const sequentialActions2 = Object.values(course.lectures.items).filter(lecturesByWeek => {
